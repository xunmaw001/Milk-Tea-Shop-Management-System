		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">奶茶分类管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">奶茶分类管理</li>
								<li class="breadcrumb-item active">奶茶分类列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">奶茶分类列表</h3>							
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('shangpinfenlei')">奶茶分类<i id="shangpinfenleiIcon" class="fa fa-sort"></i></th>
																																					<th>操作</th>
										</tr>
									</thead>
									<tbody>
