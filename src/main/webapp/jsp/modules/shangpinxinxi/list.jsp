    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">奶茶信息管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">奶茶信息管理</li>
                        <li class="breadcrumb-item active">奶茶信息列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">奶茶信息列表</h3>
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('shangpinmingcheng')">奶茶名称<i id="shangpinmingchengIcon"
                                                                                   class="fa fa-sort"></i></th>
                                    <th onclick="sort('shangpinfenlei')">奶茶分类<i id="shangpinfenleiIcon"
                                                                                class="fa fa-sort"></i></th>
                                    <th onclick="sort('shuliang')">数量<i id="shuliangIcon" class="fa fa-sort"></i></th>
                                    <th onclick="sort('pinpai')">奶茶品牌<i id="pinpaiIcon" class="fa fa-sort"></i></th>
