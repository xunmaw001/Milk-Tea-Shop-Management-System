          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="shangpinmingcheng" id="shangpinmingcheng" placeholder="奶茶名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">奶茶分类</label>
              <div class="layui-input-inline">
                <input type="text" name="shangpinfenlei" id="shangpinfenlei" placeholder="奶茶分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
          ...
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../shangpinxinxi/detail.jsp?id='+item.id">
                ...
                <div class="remark">
                  <h5>奶茶:{{item.shangpinmingcheng}}</h5>
