...
<body scrolling="no" style="overflow-y: hidden;overflow-x: hidden;">
      ...
      <div class="container">
        ...
        <div id="nav" class="nav nav-a fr">
          <ul>
            ...
            <li id="aaaaa"><a target="_blank" :href="'javascript:window.location.href=\''+adminurl+'\''">跳转到后台</a></li>
            <%--<li v-if="cartFlag">
            ...
            <%--<li style="display: flex; height: 80px;align-items: center;">
            	<input type="text" name="shangpinmingcheng" id="shangpinmingcheng" placeholder="商品名称" autocomplete="off" class="layui-input">

            </li>
            <li style="display: flex; height: 80px;align-items: center;">
            	<!-- <a style="color:#000000" :href="javascript:navPage('./pages/shangpinxinxi/list.jsp')">搜索</a> -->
            	<a id="btn-search" href="javascript:search('./pages/shangpinxinxi/list.jsp?shangpinmingcheng=')" type="button" class="layui-btn" style="background-color: #000000;">搜索</a>
            </li>--%>
          </ul>
        </div>
      </div>
  ...
  <script>
    ...
    // 导航栏跳转
    function search(url) {
      var shangpinmingcheng = document.getElementById('shangpinmingcheng').value
      localStorage.setItem('iframeUrl', url+shangpinmingcheng);
      document.getElementById('iframe').src = url+shangpinmingcheng;
    }
